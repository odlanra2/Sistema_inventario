        ...
        <form>
            ...
            <div class="container">
               ...
               <div  class="col-md-10">
			    ...
			    <input type="text" name='referencia' value= '<?php echo  @$producto["referencia"] ?>' class="form-control" id="exampleInputPassword1" require  placeholder="Referencia">
			    ...
			    <input type="number" name='precio'  value= '<?php echo  @$producto["precio"] ?>' class="form-control" id="exampleInputEmail1" require aria-describedby="emailHelp" placeholder="Precio">
				  ...
				  <div class="col-md-6">
				   <label for="exampleInputPassword1">Peso:</label>
			        <input type="number" name='peso' value= '<?php echo  @$producto["peso"] ?>' class="form-control" id="exampleInputPassword1"  require placeholder="Peso">
			  ...
			  <div class="row form-group">
			    ...
			    <input type="text" name="categoria" value='<?php echo  @$producto["categoria"] ?>' class="form-control" id="exampleInputPassword1" require  placeholder="categoria">
